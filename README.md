...
Just want the web UI? Double-click `start.cmd` (Windows) / `start.command` (macOS) or run `./start.sh` (Linux) inside the unpacked folder — it starts the server and opens the page in your browser.
